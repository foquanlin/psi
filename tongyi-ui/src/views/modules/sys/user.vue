  ...
  <div class="mod-user">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:user:delete')" type="danger" @click="resetHandle()" :disabled="dataListSelections.length <= 0">重置密码</el-button>
      </el-form-item>
    </el-form>
    <el-table :data="dataList" border @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="orgNo" header-align="center" align="center" label="所属机构">
        <template v-slot="scope">
