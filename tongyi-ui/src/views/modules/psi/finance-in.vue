<template>
  <div class="mod-finance">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        <select-finance-type v-model="searchForm" field="typeId" type="IN" placeholder="收入类型"/>
      </el-form-item>
      <el-form-item>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <finance-edit v-if="editVisible" type="IN" ref="financeEdit" @refreshDataList="getDataList"/>
