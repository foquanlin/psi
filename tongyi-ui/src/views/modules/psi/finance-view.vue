<template>
  <el-dialog title="订单详情" :close-on-click-modal="false" width="70%" :visible.sync="visible">
    ...
    <div style="margin-top:20px;align-content: center;align-items: center;text-align: center;">
