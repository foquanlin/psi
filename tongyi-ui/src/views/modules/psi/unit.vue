  ...
  <div class="mod-unit">
    <el-form :inline="true" :model="searchForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('psi:unit:save')" type="primary" @click="editHandle()">新增</el-button>
        <el-button v-if="isAuth('psi:unit:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table border :data="dataList" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('psi:unit:info')" type="text" size="small" @click="showDetails(scope.row.id)">查看</el-button>
          <el-button v-if="isAuth('psi:unit:update')" type="text" size="small" @click="editHandle(scope.row.id)">修改</el-button>
          <el-button v-if="isAuth('psi:unit:delete')" type="text" size="small" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <unit-edit v-if="editVisible" ref="unitEdit" @refreshDataList="getDataList"/>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      showDetails (id) {
        ...
        this.$nextTick(() => {
          this.$refs.unitEdit.init(id, true)
        })
      },
      // 新增 / 修改
      editHandle (id) {
