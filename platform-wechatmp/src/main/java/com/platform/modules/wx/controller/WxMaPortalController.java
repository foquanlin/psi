...
public class WxMaPortalController {
    ...
    public String authGet(@PathVariable String appid,
        ...
        this.maService.switchoverTo(appid);
...
//				openid, signature, encType, msgSignature, timestamp, nonce, requestBody);
        ...
        if (encType == null) {
            ...
            WxMaXmlOutMessage outMessage = this.route(appid,inMessage);
            if (outMessage == null) {
                return "";
            }
            ...
            // aes加密的消息
            WxMaMessage inMessage = WxMaMessage.fromEncryptedXml(requestBody, maService.getWxMaConfig(),
            ...
            out = outMessage.toEncryptedXml(maService.getWxMaConfig());
        }
    ...
    private WxMaXmlOutMessage route(String appid, WxMaMessage message) {
        try {
