...
import com.tongyi.modules.wx.dao.MsgTemplateMapper;
...
import com.tongyi.modules.wx.service.MsgTemplateService;
...
public class MsgTemplateServiceImpl extends ServiceImpl<MsgTemplateMapper, MsgTemplate> implements MsgTemplateService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<MsgTemplate> page = this.page(
            new Base64Util.Query<MsgTemplate>().getPage(params),
