...
import com.tongyi.modules.wx.dto.PageSizeConstant;
...
import com.tongyi.common.utils.Base64Util;
import com.tongyi.common.utils.PageUtils;
import com.tongyi.modules.wx.dao.ArticleMapper;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements ArticleService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<Article> page = this.page(
            new Base64Util.Query<Article>().getPage(params),
    ...
    public boolean save(Article article) {
        ...
        if (article.getId() > 0) {
            ...
            if (count > 0) {
                throw new BusinessException("同目录下文章[" + title + "]已存在，不可重复添加");
            }
