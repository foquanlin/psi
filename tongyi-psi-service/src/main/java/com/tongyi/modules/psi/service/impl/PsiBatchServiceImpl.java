...
public class PsiBatchServiceImpl extends ServiceImpl<PsiBatchDao, PsiBatchEntity> implements PsiBatchService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiBatchEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiBatchEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiBatchEntity entity, Map<String, Object> params, ModuleExecute<PsiBatchEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiBatchEntity entity, Map<String, Object> params, ModuleExecute<PsiBatchEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
