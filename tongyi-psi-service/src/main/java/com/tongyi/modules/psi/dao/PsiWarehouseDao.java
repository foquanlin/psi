...
public interface PsiWarehouseDao extends BaseMapper<PsiWarehouseEntity> {
     ...
     * @return List
     */
    List<PsiWarehouseEntity> listAll(@Param("params") Map<String, Object> params);
