...
public class PsiGoodsSkuServiceImpl extends ServiceImpl<PsiGoodsSkuDao, PsiGoodsSkuEntity> implements PsiGoodsSkuService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiGoodsSkuEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiGoodsSkuEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiGoodsSkuEntity entity, Map<String, Object> params, ModuleExecute<PsiGoodsSkuEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiGoodsSkuEntity entity, Map<String, Object> params, ModuleExecute<PsiGoodsSkuEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
