...
public class PsiUnitServiceImpl extends ServiceImpl<PsiUnitDao, PsiUnitEntity> implements PsiUnitService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiUnitEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiUnitEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiUnitEntity entity, Map<String, Object> params, ModuleExecute<PsiUnitEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiUnitEntity entity, Map<String, Object> params, ModuleExecute<PsiUnitEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
