...
public class PsiBrandServiceImpl extends ServiceImpl<PsiBrandDao, PsiBrandEntity> implements PsiBrandService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiBrandEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiBrandEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiBrandEntity entity, Map<String, Object> params, ModuleExecute<PsiBrandEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiBrandEntity entity, Map<String, Object> params, ModuleExecute<PsiBrandEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
