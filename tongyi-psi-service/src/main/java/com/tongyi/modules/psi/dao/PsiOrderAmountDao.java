...
public interface PsiOrderAmountDao extends BaseMapper<PsiOrderAmountEntity> {
     ...
     * @return List
     */
    List<PsiOrderAmountEntity> listAll(@Param("params") Map<String, Object> params);
