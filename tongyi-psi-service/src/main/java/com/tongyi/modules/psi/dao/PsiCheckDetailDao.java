...
public interface PsiCheckDetailDao extends BaseMapper<PsiCheckDetailEntity> {
     ...
     * @return List
     */
    List<PsiCheckDetailEntity> listAll(@Param("params") Map<String, Object> params);
