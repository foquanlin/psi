...
public interface PsiGoodsSpecDao extends BaseMapper<PsiGoodsSpecEntity> {
     ...
     * @return List
     */
    List<PsiGoodsSpecEntity> listAll(@Param("params") Map<String, Object> params);
