...
public class PsiAllocationGoodsServiceImpl extends ServiceImpl<PsiAllocationGoodsDao, PsiAllocationGoodsEntity> implements PsiAllocationGoodsService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiAllocationGoodsEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiAllocationGoodsEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiAllocationGoodsEntity entity, Map<String, Object> params, ModuleExecute<PsiAllocationGoodsEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiAllocationGoodsEntity entity, Map<String, Object> params, ModuleExecute<PsiAllocationGoodsEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
