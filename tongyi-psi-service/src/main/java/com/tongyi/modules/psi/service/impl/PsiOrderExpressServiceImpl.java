...
public class PsiOrderExpressServiceImpl extends ServiceImpl<PsiOrderExpressDao, PsiOrderExpressEntity> implements PsiOrderExpressService{
    ...
    @Override
    public void execute(Serializable id, Map<String, Object> params, ModuleExecute<PsiOrderExpressEntity, Map<String, Object>, Void> fun) {
        Objects.requireNonNull(id);
        Objects.requireNonNull(fun);
        PsiOrderExpressEntity entity = this.getById(id);
        this.execute(entity,params,fun);
    }

    @Override
    public void execute(PsiOrderExpressEntity entity, Map<String, Object> params, ModuleExecute<PsiOrderExpressEntity, Map<String, Object>, Void> fun) {
    ...
    @Override
    public void execute(PsiOrderExpressEntity entity, Map<String, Object> params, ModuleExecute<PsiOrderExpressEntity, Map<String, Object>, Void>... funs) {
        Objects.requireNonNull(entity);
