/*
 * 项目名称:项目名称
 * 类名称:PsiOrderAmountMockTest.java
...
import com.tongyi.modules.psi.controller.PsiOrderAmountController;
...
public class PsiOrderAmountMockTest {
    @Autowired
    ...
    @Autowired
    protected PsiOrderAmountController controller; // 把要测试的controller注入进来
