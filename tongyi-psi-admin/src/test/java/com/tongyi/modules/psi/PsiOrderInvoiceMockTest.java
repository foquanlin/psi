/*
 * 项目名称:项目名称
 * 类名称:PsiOrderInvoiceMockTest.java
...
import com.tongyi.modules.psi.controller.PsiOrderInvoiceController;
...
public class PsiOrderInvoiceMockTest {
    @Autowired
    ...
    @Autowired
    protected PsiOrderInvoiceController controller; // 把要测试的controller注入进来
