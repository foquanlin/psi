...
import com.tongyi.modules.psi.controller.PsiBankController;
...
public class PsiBankMockTest {
    ...
    @Autowired
    protected PsiBankController controller; // 把要测试的controller注入进来
