...
import com.tongyi.modules.psi.controller.PsiBrandController;
...
public class PsiBrandMockTest {
    ...
    @Autowired
    protected PsiBrandController controller; // 把要测试的controller注入进来
