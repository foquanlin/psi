...
import com.tongyi.modules.psi.controller.PsiBatchController;
...
public class PsiBatchMockTest {
    ...
    @Autowired
    protected PsiBatchController controller; // 把要测试的controller注入进来
